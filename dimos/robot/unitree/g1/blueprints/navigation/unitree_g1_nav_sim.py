...
"""G1 with SmartNav autonomous navigation in Unity simulation.

Zero-ROS navigation stack: uses SmartNav C++ native modules for terrain
analysis, local planning, and path following, with the Unity simulator
providing lidar and camera data via TCP bridge.

Unlike ROSNav, this does NOT require Docker or ROS — all navigation
runs as native DimOS modules with LCM transport.
"""
